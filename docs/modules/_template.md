...
## Platform notes
- **iOS**: `SendRate/Features/<Name>/<Name>View.swift`
- **Web**: `web/app/.../page.tsx` (after migration from `SendRate-Web/index.html`)
- **Android**: `android/app/src/main/java/com/sendrate/features/<name>/<Name>Screen.kt`
